...
class PubSubRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:workflowserver.PubSubRequest) */ {
 public:
  ...
  const ::std::string& pubsubmessage() const;
  void set_pubsubmessage(const ::std::string& value);
  #if LANG_CXX11
  void set_pubsubmessage(::std::string&& value);
  #endif
  void set_pubsubmessage(const char* value);
  void set_pubsubmessage(const char* value, size_t size);
  ::std::string* mutable_pubsubmessage();
  ::std::string* release_pubsubmessage();
  void set_allocated_pubsubmessage(::std::string* pubsubmessage);

  // @@protoc_insertion_point(class_scope:workflowserver.PubSubRequest)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::ArenaStringPtr pubsubmessage_;
  mutable int _cached_size_;
  friend struct protobuf_workflowserver_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
inline const ::std::string& PubSubRequest::pubsubmessage() const {
  // @@protoc_insertion_point(field_get:workflowserver.PubSubRequest.pubsubmessage)
  return pubsubmessage_.GetNoArena();
}
inline void PubSubRequest::set_pubsubmessage(const ::std::string& value) {
...
#if LANG_CXX11
inline void PubSubRequest::set_pubsubmessage(::std::string&& value) {
...
#endif
inline void PubSubRequest::set_pubsubmessage(const char* value) {
  GOOGLE_DCHECK(value != NULL);
...
inline void PubSubRequest::set_pubsubmessage(const char* value, size_t size) {
...
inline ::std::string* PubSubRequest::mutable_pubsubmessage() {
...
inline ::std::string* PubSubRequest::release_pubsubmessage() {
...
inline void PubSubRequest::set_allocated_pubsubmessage(::std::string* pubsubmessage) {

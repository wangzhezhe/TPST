...
PubSubRequest::PubSubRequest(const PubSubRequest& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(NULL),
      pubsubmessage_(from.pubsubmessage_),
      _cached_size_(0) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u /* 10 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->add_pubsubmessage()));
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            this->pubsubmessage(this->pubsubmessage_size() - 1).data(),
            static_cast<int>(this->pubsubmessage(this->pubsubmessage_size() - 1).length()),
            ::google::protobuf::internal::WireFormatLite::PARSE,
...
void PubSubRequest::SerializeWithCachedSizes(
  ...
  // repeated string pubsubmessage = 1;
  for (int i = 0, n = this->pubsubmessage_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      this->pubsubmessage(i).data(), static_cast<int>(this->pubsubmessage(i).length()),
      ::google::protobuf::internal::WireFormatLite::SERIALIZE,
      "workflowserver.PubSubRequest.pubsubmessage");
    ::google::protobuf::internal::WireFormatLite::WriteString(
      1, this->pubsubmessage(i), output);
  }
...
::google::protobuf::uint8* PubSubRequest::InternalSerializeWithCachedSizesToArray(
  ...
  for (int i = 0, n = this->pubsubmessage_size(); i < n; i++) {
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      WriteStringToArray(1, this->pubsubmessage(i), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:workflowserver.PubSubRequest)
  ...
  // repeated string pubsubmessage = 1;
  total_size += 1 *
      ::google::protobuf::internal::FromIntSize(this->pubsubmessage_size());
  for (int i = 0, n = this->pubsubmessage_size(); i < n; i++) {
    total_size += ::google::protobuf::internal::WireFormatLite::StringSize(
      this->pubsubmessage(i));
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:workflowserver.PubSubRequest)
  ...
  pubsubmessage_.MergeFrom(from.pubsubmessage_);
}
...
void PubSubRequest::InternalSwap(PubSubRequest* other) {
  using std::swap;
  pubsubmessage_.InternalSwap(&other->pubsubmessage_);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_cached_size_, other->_cached_size_);
}
